...
public class FamilyMemberController {
    ...
    @GetMapping("")
    public ResponseEntity<List<FamilyMember>> getMembersByFamilyId(@PathVariable(name = "id") Long familyId) {
        return ResponseEntity.ok(familyMemberService.getMembersByFamilyId(familyId));
    }

    @PostMapping("")
    public ResponseEntity<FamilyMember> addMemberToFamily(@RequestBody @Valid AddMemberToFamilyRequest familyMember, @PathVariable(name = "id") Long id) {
